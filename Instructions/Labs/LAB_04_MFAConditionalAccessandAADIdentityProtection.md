...
5. **새 사용자** 블레이드에서 **사용자 만들기** 옵션이 선택되어 있는지 확인하고 다음 설정을 지정하고(다른 모든 설정은 기본값으로 유지) **만들기**를 클릭합니다.
...
7. **새 사용자** 블레이드에서 **사용자 만들기** 옵션이 선택되어 있는지 확인하고 다음 설정을 지정하고(다른 모든 설정은 기본값으로 유지) **만들기**를 클릭합니다. 
...
2. 사용자 계정의 속성을 표시하는 블레이드에서 **속성 편집**을 클릭합니다.  사용 위치를 설정하지 않았다면 사용 위치가 **미국**으로 설정되어 있는지 확인하고 **저장**을 클릭합니다.
...
2. **AdatumLab500-04** Azure AD 테넌트 > **보안** > **조건부 액세스**로 이동합니다.

3. **새 정책**을 클릭합니다.

4. **이름** 텍스트 상자에 다음 정책 이름을 입력하고 **AZ500Policy2**를 입력합니다.

5. **할당**에서 **사용자**를 선택합니다.

6. **포함**에서 **사용자 및 그룹 선택**을 클릭하고 **aaduser2** 및 **aaduser3**을 선택합니다.

7. **제외**에서 **사용자 및 그룹**을 클릭하고 **aaduser1**을 선택합니다. 

8. **클라우드 앱 또는 작업** > **포함**에서 **모든 클라우드 앱**을 선택합니다.

9. **조건** > **사용자 위험**에서 **구성**을 **예**로 설정합니다.

10. **정책을 적용하는 데 필요한 사용자 위험 수준 구성**에서 **높음**을 선택합니다.

11. **Done**을 클릭합니다.

12. **액세스 제어** > **허용**이 사용하도록 설정되어 있는지 확인합니다.    

13. **다단계 인증 필요** 및 **암호 변경 필요**를 선택합니다.

14. **선택**을 클릭합니다.

15. **세션**에서 **로그인 빈도**를 클릭하고 **모든 시간**이 사용하도록 설정되어 있는지 확인합니다.

16. **선택**을 클릭합니다.

17. 설정을 확인하고 **정책 사용**을 **보고 전용**으로 설정합니다.

    >**참고**: 다음 메시지가 페이지 하단에 표시됩니다. **“조직의 보안 구성을 관리하려는 것 같습니다. 조건부 액세스 정책을 사용하도록 설정하기 전에 먼저 보안 기본값을 사용하지 않도록 설정해야 합니다.”**

18. 다음과 같은 메시지 부분을 클릭합니다. **보안 기본값을 사용하지 않도록 설정합니다**.

19. **보안 기본값 사용**을 예에서 **아니요**로 변경합니다.

20. **기타**를 클릭하고 **AZ500 랩 사용** 필드에 다음을 입력합니다.

21. **저장**을 클릭합니다.

22. **만들기**를 클릭하여 정책을 사용하도록 설정합니다.

#### 작업 3: 로그인 위험 정책 구성

1. **AdatumLab500-04** Azure AD 테넌트 > **보안** > **조건부 액세스**로 이동합니다.
...
5. **포함**에서 **사용자 및 그룹 선택**을 클릭하고 **aaduser2** 및 **aaduser3**을 선택합니다.

6. **제외**에서 **사용자 및 그룹**을 클릭하고 **aaduser1**을 선택합니다. 

7. **클라우드 앱 또는 작업** > **포함**에서 **모든 클라우드 앱**을 선택합니다.

8. **조건** > **로그인 위험**에서 **구성**을 **예**로 설정합니다.

9. **이 정책을 적용할 로그인 위험 수준 선택** 아래에서 **높음** 및 **중간**을 선택합니다.

10. **Done**을 클릭합니다.

11. **액세스 제어********권한 부여**에서 다음을 수행합니다.  

12. **액세스 권한 부여**, **다단계 인증 필요**를 선택합니다.

13. **선택**을 클릭합니다.

13. **세션**에서 **로그인 빈도**를 선택하고 **모든 시간**이 사용하도록 설정되어 있는지 확인합니다.

14. **선택**을 클릭합니다.

15. 설정을 확인하고 **정책 사용**을 **보고 전용**으로 설정합니다.

16. **만들기**를 클릭하여 정책을 사용하도록 설정합니다.
